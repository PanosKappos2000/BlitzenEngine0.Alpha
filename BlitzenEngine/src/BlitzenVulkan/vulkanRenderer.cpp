...
namespace BlitzenRendering
{
    ...
    void VulkanRenderer::InitMeshNodes()
    {
        for(size_t i = 0; i < m_assets.size(); ++i)
        {
            ...
            //Set some base transform for the node
            newNode.localTransform = glm::mat4{ 1.f };
		    newNode.worldTransform = glm::mat4{ 1.f };

            //Give the default material to the surfaces of the mesh
    ...
    void VulkanRenderer::DrawGeometry(const VkCommandBuffer& commandBuffer)
    {
        ...
        *pSceneData = m_globalSceneData;
        ...
        for(size_t i = 0; i < m_mainDrawContext.opaqueObjects.size(); ++i)
        {
            ...
            vkCmdBindDescriptorSets(commandBuffer, VK_PIPELINE_BIND_POINT_GRAPHICS, m_mainDrawContext.opaqueObjects[i].
            pMaterial->pPipeline->pipelineLayout, 1, 1, &(m_mainDrawContext.opaqueObjects[i].pMaterial->descriptorSet), 0, nullptr);
